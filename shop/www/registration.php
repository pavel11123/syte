      ...
      $('#form_reg').validate(
                {   
                    ...
                    messages:{
                     ...
                     // происходит сама регистрация пользователя
    submitHandler: function(form){ // если все введено правильно будет отправляться сообщение в обработчик
    $(form).ajaxSubmit({
    success: function(data) { 
                                  
        if (data == 'true') // если обработчик отправляет true то выполняются действия
    {
